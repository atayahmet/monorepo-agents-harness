...
#
#   git pre-commit:  ln -s ../../turborepo-harness-template/core/scripts/memory-gate.sh .git/hooks/pre-commit
#   CI:              bash turborepo-harness-template/core/scripts/memory-gate.sh
