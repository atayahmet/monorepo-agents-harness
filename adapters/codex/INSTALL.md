...
| Intent execution (`/monorepo-harness-intent-execute`) | `core/skills/intent-workflow/SKILL.md` "Workflow — Execute" + `core/scripts/tracker-issue.sh` | `/monorepo-harness-intent-execute` skill · issues created inline (no subagent primitive) |
