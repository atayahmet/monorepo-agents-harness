---
name: monorepo-harness-review
description: Review the current diff against REVIEW.md policy and, when possible, this task's plan/spec/verify artifacts. Use when the user types /monorepo-harness-review or asks to review a PR, diff, or set of changes.
---
...
3. Look for a matching task under `.agents/artifacts/*/index.md`; if found, use its
   `2_plan.md`/`1_spec.md`/`4_verify.md` as ground truth for a spec-compliance pass.
