...
description: Check the installed harness version against upstream and, with consent, upgrade it. Use when the user types /monorepo-harness-update or asks to check/update the harness.
---
